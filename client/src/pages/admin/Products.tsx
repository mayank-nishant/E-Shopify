...
function AdminProducts() {
  const { search, setSearch, products, categories, loading, categoryDialogOpen, setcategoryDialogOpen, productDialogOpen, setProductDialogOpen, editingProduct, openCreateDialog, closeProductDialog, refreshAll, openEditDialog } = useAdminProducts();
    ...
    <div className={pageWrap}>
      <Card className={cardClass}>
        <CardHeader className={cardHeaderClass}>
          ...
          <ProductToolbar search={search} onSearchChange={setSearch} onManageCategories={() => setcategoryDialogOpen(true)} onAddProduct={openCreateDialog} />
        </CardHeader>
