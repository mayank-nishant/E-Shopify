...
const contentClass = "flex flex-col items-center gap-3 text-sm text-muted-foreground";
...
export function Commonloader({ text = "Loading...", className, iconClassName }: CommonLoaderProps) {
  return (
